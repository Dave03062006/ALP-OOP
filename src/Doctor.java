...
public class Doctor extends Staff {
    ...
    // onDuty kenapa harus dipake: dokter bisa aja onDuty tapi tidak terima pasien/ kalo misal ada emergency 
    ...
    //  overriding since the base class User or staff defines a general register method without the specialist parameter 
    @Override
    ...
    // THIS overloaded register method is specific for doctors, including specialist information
    ...
    public void diagnosePatient(Appointment appointment, String diagnosis) {
        ...
        try {
            ...
            int result = pstmt.executeUpdate();
            if (result > 0) {
                System.out.println("Diagnosis updated successfully for appointment ID: " + appointment.getAppointmentId());
            } else {
