...
public class PanelFactory {
    ...
    public static JPanel createRegistrationPanel(String role, CardLayout cardLayout, JPanel cardPanel,
        ...
        if (role.equals("Patient")) {
            specificLabel = new JLabel("ID Number:");
            specificField.setToolTipText("Enter your ID number");
        ...
        specificLabel.setForeground(TEXT_COLOR);
        gbc.gridx = 0;
        gbc.gridy = 5;
        panel.add(specificLabel, gbc);

        gbc.gridx = 0;
        gbc.gridy = 6;
        panel.add(specificField, gbc);
